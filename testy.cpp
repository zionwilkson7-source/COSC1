...
int main () {
   ...
   // then output your position in the queue. 
   // When you are at the head, output that you can purchase your ticket.
   while (!peopleInQueue.empty()) {
      string front = peopleInQueue.front();
      peopleInQueue.pop();
      ...
      if (front == "You") {
         ...
         cout << front << " has purchased a ticket." << endl;
